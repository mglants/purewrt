...
func writeMain(b *bytes.Buffer, s Settings) {
	...
	optb(b, "proxy_guard_enabled", s.ProxyGuardEnabled)
	optNonEmpty(b, "proxy_guard_cron", s.ProxyGuardCron)
	opti(b, "proxy_guard_min_members", s.ProxyGuardMinMembers)
	opti(b, "proxy_guard_min_down_kbps", s.ProxyGuardMinDownKbps)
	opti(b, "proxy_guard_probe_bytes", s.ProxyGuardProbeBytes)
	opti(b, "proxy_guard_max_jitter_ms", s.ProxyGuardMaxJitterMS)
	opti(b, "proxy_guard_active_probe_interval", s.ProxyGuardActiveProbeInterval)
	opti(b, "proxy_guard_fleet_probe_interval", s.ProxyGuardFleetProbeInterval)
	opti(b, "proxy_guard_quarantine_seconds", s.ProxyGuardQuarantineSeconds)
